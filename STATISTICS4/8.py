...
data = pd.read_excel('C:/Users/brais/OneDrive/Desktop/ML/STATISTICS4/8.xlsx')
...
def perform_kmeans(X, k, random_state=42):
    ...
    # Round center values to 1 decimal place
    largest_cluster_center_rounded = np.round(largest_cluster_center, 1)
